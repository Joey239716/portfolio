...
export default function GitHubLink() {
  return (
    <a
      ...
      className="fixed top-6 right-6 z-20 flex items-center gap-2 rounded-full border border-foreground/10 bg-background/80 px-3 py-1.5 backdrop-blur transition-colors hover:border-foreground/20 hover:bg-foreground/5"
    >
      <Image
